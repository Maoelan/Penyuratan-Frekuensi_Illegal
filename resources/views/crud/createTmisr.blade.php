        ...
        <div class="row justify-content-center">
            <div class="card width:200rem;" >
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ url('/tmisrStore') }}" enctype="multipart/form-data">
                    @csrf
                    <p class="text-center fs-6 fw-bold">{{ __('Masukkan Data Yang Tidak Memiliki Izin Stasiun Radio') }}</p>
                    <div class="card">
                        <div class="card-body">

                            <div class="row mb-3">
                                <label for="nomer_surat" class="col-md-4 col-form-label text-md-end">{{ __('Nomer Surat') }}</label>
    
                                <div class="col-md-6">
                                    <input id="nomer_surat" type="text" class="form-control @error('nomer_surat') is-invalid @enderror" name="nomer_surat" value="{{ old('nomer_surat') }}" required autocomplete="nomer_surat" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_stasiun" type="text" class="form-control @error('nama_stasiun') is-invalid @enderror" name="nama_stasiun" value="{{ old('nama_stasiun') }}" required autocomplete="nama_stasiun" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="alamat_stasiun" type="textarea" class="form-control @error('alamat_stasiun') is-invalid @enderror" name="alamat_stasiun" value="{{ old('alamat_stasiun') }}" required autocomplete="alamat_stasiun" autofocus></textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="koordinat" type="text" class="form-control @error('koordinat') is-invalid @enderror" name="koordinat" value="{{ old('koordinat') }}" required autocomplete="koordinat" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="stasiun_lawan" type="text" class="form-control @error('stasiun_lawan') is-invalid @enderror" name="stasiun_lawan" value="{{ old('stasiun_lawan') }}" required autocomplete="stasiun_lawan" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="tx" type="number" step="0.000001" class="form-control @error('tx') is-invalid @enderror" name="tx" value="{{ old('tx') }}" required autocomplete="tx" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="rx" type="number" step="0.000001" class="form-control @error('rx') is-invalid @enderror" name="rx" value="{{ old('rx') }}" required autocomplete="rx" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="bw" type="number" step="0.000001" class="form-control @error('bw') is-invalid @enderror" name="bw" value="{{ old('bw') }}" required autocomplete="bw" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="jenis_barang" type="text" class="form-control @error('jenis_barang') is-invalid @enderror" name="jenis_barang" value="{{ old('jenis_barang') }}" required autocomplete="jenis_barang" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="merk_type" type="text" class="form-control @error('merk_type') is-invalid @enderror" name="merk_type" value="{{ old('merk_type') }}" required autocomplete="merk_type" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="lokasi_segel" class="col-md-4 col-form-label text-md-end">{{ __('Lokasi Segel') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="jenis_barang_dua" type="text" class="form-control @error('jenis_barang_dua') is-invalid @enderror" name="jenis_barang_dua" value="{{ old('jenis_barang_dua') }}" required autocomplete="jenis_barang_dua" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="merk_type_dua" type="text" class="form-control @error('merk_type_dua') is-invalid @enderror" name="merk_type_dua" value="{{ old('merk_type_dua') }}" required autocomplete="merk_type_dua" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="lokasi_segel_dua" type="text" class="form-control @error('lokasi_segel_dua') is-invalid @enderror" name="lokasi_segel_dua" value="{{ old('lokasi_segel_dua') }}" required autocomplete="lokasi_segel_dua" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="mulai_beroperasi" type="date" placeholder ="mulai_beroperasi" class="form-control @error('mulai_beroperasi') is-invalid @enderror" name="mulai_beroperasi" value="{{ old('mulai_beroperasi') }}" required autocomplete="mulai_beroperasi" autofocus>
