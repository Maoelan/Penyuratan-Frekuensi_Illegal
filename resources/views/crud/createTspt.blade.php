    ...
    <div class="container" style="width:200rem;">
        <div class="row justify-content-center">
            <div class="card width:200rem;" >
                <div class="card-header text-center fs-6 fw-bold" style="background-color:#0166FE; color:white; font-size:1rem;">{{ __('TIDAK SESUAI PARAMETER TEKNIS') }}</div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    @endif
                    <form method="POST" action="{{ url('/tsptStore') }}" enctype="multipart/form-data">
                    @csrf
                    <p class="text-center fs-6 fw-bold">{{ __('Masukkan Data Yang Tidak Sesuai Parameter Teknis') }}</p>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="rx" type="number" class="form-control @error('rx') is-invalid @enderror" name="rx" value="{{ old('rx') }}" required autocomplete="rx" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="bw" class="col-md-4 col-form-label text-md-end">{{ __('Bw (MHz)') }}</label>
    
                                <div class="col-md-6">
                                    <input id="bw" type="number" class="form-control @error('bw') is-invalid @enderror" name="bw" value="{{ old('bw') }}" required autocomplete="bw" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nomer_isr" type="text" class="form-control @error('nomer_isr') is-invalid @enderror" name="nomer_isr" value="{{ old('nomer_isr') }}" required autocomplete="nomer_isr" autofocus>
